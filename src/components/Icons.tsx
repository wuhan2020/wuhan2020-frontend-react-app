...
export const IconHomeBottomBanner = Icon(require('../images/icons/home-bottom-banner.svg'));
export const IconHotel = Icon(require('../images/icons/icon-hotel.svg'));
export const IconQinghuaLogo = Icon(require('../images/icons/icon-qinghualogo.svg'));
export const IconRenminPaper = Icon(require('../images/icons/icon-renminpaper.svg'));
